...
with DAG(
    ...
    bash_task_2 = BashOperator(
        task_id="bash_task_2",
        env={
            "START_DATE": "{{ (data_interval_start.in_timezone('Asia/Seoul') - macros.dateutil.relativedelta.relativedelta(weeks=2) - macros.dateutil.relativedelta.relativedelta(days=5)) | ds }}",
